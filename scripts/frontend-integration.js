 ...
 * This file demonstrates how to integrate Emberhinge with a web frontend
 */

// For React/Vue/Angular applications
export class EmberhingeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmberhingeClient(provider, contractAddress);
